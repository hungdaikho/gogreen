...
import { CheckIcon, SelectIcon } from "../../icons/Editor";
...
export function Select({ variant = "regular", initialValue, value, items, onChange, placeholder, aboveOverlay, className, ...props }: Props) {
	...
	return (
		<RadixSelect.Root value={internalValue} onValueChange={handleValueChange} defaultValue={initialValue} {...props}>
			<RadixSelect.Trigger
				...
				>
					<RadixSelect.Viewport>
						{items.map(({ value, title, description, ...props }) => (
							<RadixSelect.Item key={value} value={value} className={styles.item} {...props}>
								...
								<div className={styles.itemInfo}>
									<RadixSelect.ItemText className={styles.itemTitle}>{title ?? value}</RadixSelect.ItemText>
